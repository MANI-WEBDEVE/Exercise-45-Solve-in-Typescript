const oldGuests: Array<string> = ["Muhammad Waqar", "Muahmmad Dawar", "Muhammad Qasim", "Muhammad Umer", "Muhammad Usman", "Muhammad Jawade", "Muhammad Uzair" ];
//----
...
//---
const invetation = (oldGuests:string[]):void => {
