const favFruit:Array<string>=["Mango", "Banana", "pineApple", "Orange", "strawberry"];
if (favFruit.includes("apple")) {
    console.log("I love Apple");
}else{
    console.log("i don`t like this Apple")
}
