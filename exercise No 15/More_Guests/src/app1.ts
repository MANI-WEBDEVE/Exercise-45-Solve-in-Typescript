const guest:string[] = ["Abdul Kareem", "Abdul Raheem", "Abdul Rafee", "Muhammad Ahade", "Muhammad zain", "Muhammad Ali ", "Muhammad Haseeb"];
...
//---------
const invetationGuest = (guest:string[]):void => {
